...
// Admin read-only detail view. Mirrors the doctor detail page minus any
// consume-related affordances — admins audit prescriptions, they do not
// dispense them. The admin list (AdminPrescriptionsView) generates its
// View link as `${routes.admin.prescriptions}/${id}` and this route
// is the matching target. Without this file the link 404s to "Lost path".
